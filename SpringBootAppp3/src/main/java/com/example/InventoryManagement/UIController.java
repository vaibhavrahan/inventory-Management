...
public String getAllProduct(Model model) {
    ...
    return "list-product";}
@GetMapping("/customer/updateFormProduct/{id}")
...
@GetMapping("/customer/Supplierregistration")
...
@PostMapping("/customer/saveSupplier")
...
@GetMapping("/customer/updateFormSupplier/{id}")
...
@GetMapping("/customer/deleteSupplier/{id}")
...
@GetMapping("/customer/Invoiceregistration")
...
@PostMapping("/customer/saveInvoice")
public String saveInvoice(@Valid  Invoice invoice, Errors errors, Model model) {
    ...
    return "redirect:/customer/getInvoices";
    
}

@GetMapping("/customer/getInvoices")
...
@GetMapping("/customer/updateFormInvoice/{id}")
...
@GetMapping("/customer/deleteInvoice/{id}")
...
//customer
@GetMapping("/customer/Customerregistration")
...
@GetMapping("/customer/updateFormCustomer/{id}")
...
@GetMapping("/customer/deleteCus/{id}")
